...
export function createParseError(message: string, loc: TextLocation) {
  return {
...
export function createParser(
  ...
  function parseField(): FieldDefinition {
    ...
    const fieldRequired: FieldRequired | null = parserequiredValuedness();
    const fieldType: FieldType = parseFieldType();
    const _nameToken: Token | null = consume(SyntaxType.Identifier);
    const nameToken: Token = requireValue(
      _nameToken,
  ...
  function parserequiredValuedness(): FieldRequired | null {
